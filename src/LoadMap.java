				...
				while(scan.hasNextLine())
				{
					...
					while(scan2.hasNext())
					{
						...
						if(!mapReader.equals("."))
						{
							...
							else if(mapReader.equals("ff")) //red flowers
							{
